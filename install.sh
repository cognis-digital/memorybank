#!/usr/bin/env sh
# Universal installer for memorybank. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/memorybank.git"
echo "Installing memorybank ..."
